 ...
 * @version 3.0.0
 * @breaking-changes
 * - Enhanced touch support with proper event handling
 * - Improved scrolling behavior with snap points
 * - Added proper TypeScript types for scroll controls
 * - Updated layout calculations for better responsiveness
 * - Enhanced item size management through context
 * - Improved empty state handling
 *
 * A horizontal scrolling container that supports:
 * - Touch and mouse drag scrolling
 * - Pagination dots for navigation
 * - Dynamic item sizing
 * - Empty state rendering
 * - Prioritized content highlighting
 *
 * @param {Object} props
 * @param {string} [props.title] - Optional title for the scroller
 * @param {React.ReactNode} props.children - Content to be scrolled
 * @param {priority} props.priority - Visual priority level
 * @param {number} props.height - Container height
 * @param {number} props.itemWidth - Width of each item
