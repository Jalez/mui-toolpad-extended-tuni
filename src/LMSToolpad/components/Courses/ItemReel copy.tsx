...
const ItemReel = ({ children, title, priority }: ItemReelProps) => {
  ...
  return (
    <>
      ...
      <Box
        className='item-reel' // Add this class for targeting
        sx={{
          position: 'relative',
          '&:hover .reel-controls': { opacity: 1 },
          userSelect: 'none',
          minHeight: 200,
          // Ensure reel is above panel content but below resize handles
          zIndex: 5,
        }}
        ...
        {canScroll && (
          <Box
            ...
            sx={{
              ...
              '& > button': {
                pointerEvents: 'auto', // Enable clicks only on buttons
                position: 'relative',
                zIndex: 'inherit',
              },
            }}>
