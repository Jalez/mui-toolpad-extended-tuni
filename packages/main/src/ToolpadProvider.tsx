...
export interface LogoConfig {
  sidebarFooter?: {
    smallLogo?: string;  // For mini sidebar
    fullLogo?: string;   // For expanded sidebar
    alt?: string;         // Alt text for logos
  };
}
...
// LogoContext for providing logo configuration to child components
const LogoContext = createContext<LogoConfig>({});
 ...
 * ```
 */
const ToolpadProvider: React.FC<ToolpadProviderProps> = ({ children, logos = {} }) => {
