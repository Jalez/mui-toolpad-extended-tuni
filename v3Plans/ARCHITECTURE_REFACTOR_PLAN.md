...
1. **Add context awareness** to navigation store for better microservice separation
2. **Implement context-aware methods** for app vs course microservice management
3. **Preserve backward compatibility** while adding enhanced functionality
